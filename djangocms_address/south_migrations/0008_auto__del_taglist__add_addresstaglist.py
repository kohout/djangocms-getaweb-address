...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'TagList'
        db.delete_table(u'djangocms_address_taglist')

        # Adding model 'AddressTagList'
        db.create_table(u'djangocms_address_addresstaglist', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'djangocms_address', ['AddressTagList'])


    def backwards(self, orm):
        # Adding model 'TagList'
        db.create_table(u'djangocms_address_taglist', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'djangocms_address', ['TagList'])

        # Deleting model 'AddressTagList'
        db.delete_table(u'djangocms_address_addresstaglist')
    ...
    models = {
        ...
        u'djangocms_address.addresstaglist': {
            'Meta': {'object_name': 'AddressTagList', '_ormbases': ['cms.CMSPlugin']},
