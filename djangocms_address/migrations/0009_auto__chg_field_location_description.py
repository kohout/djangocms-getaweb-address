...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'djangocms_address_location', 'description', self.gf('tinymce.models.HTMLField')(null=True))

    def backwards(self, orm):

        # Changing field 'Location.description'
        db.alter_column(u'djangocms_address_location', 'description', self.gf('django.db.models.fields.TextField')(null=True))
