...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.formatted_address'
        db.add_column(u'djangocms_address_location', 'formatted_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.formatted_address'
        db.delete_column(u'djangocms_address_location', 'formatted_address')
