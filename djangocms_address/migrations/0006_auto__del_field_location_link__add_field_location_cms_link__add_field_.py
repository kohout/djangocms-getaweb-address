...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'djangocms_address_location', 'link')

        # Adding field 'Location.cms_link'
        db.add_column(u'djangocms_address_location', 'cms_link',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.external_link'
        db.add_column(u'djangocms_address_location', 'external_link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.link_title'
        db.add_column(u'djangocms_address_location', 'link_title',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'djangocms_address_location', 'link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Location.cms_link'
        db.delete_column(u'djangocms_address_location', 'cms_link_id')

        # Deleting field 'Location.external_link'
        db.delete_column(u'djangocms_address_location', 'external_link')

        # Deleting field 'Location.link_title'
        db.delete_column(u'djangocms_address_location', 'link_title')
    ...
    models = {
        ...
        u'djangocms_address.location': {
            ...
            'cms_link': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.Page']", 'null': 'True', 'blank': 'True'}),
        ...
        u'djangocms_address.locationslist': {
            'Meta': {'object_name': 'LocationsList', '_ormbases': ['cms.CMSPlugin']},
        ...
        u'djangocms_address.taglist': {
            'Meta': {'object_name': 'TagList', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'sites.site': {
