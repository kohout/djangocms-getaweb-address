...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LocationsList'
        db.create_table(u'djangocms_address_locationslist', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'djangocms_address', ['LocationsList'])


    def backwards(self, orm):
        # Deleting model 'LocationsList'
        db.delete_table(u'djangocms_address_locationslist')
